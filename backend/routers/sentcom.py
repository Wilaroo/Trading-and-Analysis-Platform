...
async def chat(request: ChatRequest):
    """
    Send a message to SentCom — uses dedicated thread, immune to pool exhaustion.
...
{context}"""
            ...
            if service:
                try:
                    service._store_chat_message("user", msg)
                except Exception:
                    pass
            ...
            loop.call_soon_threadsafe(future.set_result, error_result)
