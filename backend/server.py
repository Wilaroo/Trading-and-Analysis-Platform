...
TRADING_STRATEGIES = {
    "intraday": [
        ...
        {"id": "INT-40", "name": "9 EMA Scalp", "category": "intraday",
         ...
         "ideal_conditions": ["Fresh news catalyst", "Institutional participation", "Algo buying at 9-EMA", "Strong opening drive"],
         "avoidance": ["No strong catalyst or setup", "Choppy opening move", "Too big a move before 9-EMA test (trend near end)"],
        ...
        {"id": "INT-41", "name": "ABC Scalp", "category": "intraday",
         ...
         "ideal_conditions": ["Strong A-leg uptrend", "Consistent B-leg retracement with clean trendline"],
         "avoidance": ["Trendline not well connected", "Wicks above trendline", "Last candle out of place from trendline"],
        ...
        {"id": "INT-42", "name": "Up Through Open", "category": "intraday",
         ...
         "ideal_conditions": ["Dip at open followed by strong reversal", "High volume on breaking candle"],
        ...
        {"id": "INT-43", "name": "Gap Pick and Roll", "category": "intraday",
         ...
         "ideal_conditions": ["Gap down followed by failed recovery", "Rollover with conviction"],
        ...
        {"id": "INT-44", "name": "Big Dog Consolidation", "category": "intraday",
         ...
         "ideal_conditions": ["Long consolidation (28 min ideal, 15 min minimum)", "Volume declining into breakout", "Buyers in control throughout"],
        ...
        {"id": "INT-45", "name": "Volume Capitulation (Stuffed Trade)", "category": "intraday",
         ...
         "ideal_conditions": ["Strong move to resistance", "Sharp high-volume reversal (capitulation)", "Overextended move"],
         "volume_rules": ["Capitulation volume 2x+ the 2nd highest bar", "Elevated volume on flush"],
        ...
        {"id": "INT-46", "name": "HOD Breakout (Above the Clouds)", "category": "intraday",
         ...
         "ideal_conditions": ["Strong catalyst 9+", "Decisive HOD breakout", "Sustained price above HOD"],
        ...
        {"id": "INT-47", "name": "Opening Drive", "category": "intraday",
         ...
         "ideal_conditions": ["Powerful immediate move at open", "Strong conviction", "No selling pressure"],
