...
async def get_script(script_name: str):
    ...
    allowed_scripts = ["StartTrading.bat", "ollama_http.py", "ib_data_pusher.py", "ollama_proxy.py", "ui_mockups.html", "ui_mockups_v2.html", "ui_mockups_v2_enhanced.html", "ui_mockups_chart_modal_v3.html", "ui_mockups_chart_modal_refined.html", "TradeCommand_Overview.html"]
