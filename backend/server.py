...
TRADING_STRATEGIES = {
    "intraday": [
        ...
        {"id": "INT-30", "name": "Market Context Framework", "category": "intraday",
         ...
         "market_contexts": {
             "high_strength_high_weakness": "Volatile, two-way action",
             "high_strength_low_weakness": "Strong uptrend, buy dips",
             "high_weakness_low_strength": "Strong downtrend, sell rallies",
             "low_strength_low_weakness": "Choppy, reduce size, be selective"
         },
