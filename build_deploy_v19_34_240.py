...
L.append('"""')
L.append('DGX DEPLOY v19.34.240 — trade-outcome hygiene (EV de-pollution) + MFE/MAE floor.')
L.append('')
...
L.append('         "v19.34.240 — trade-outcome hygiene (EV de-pollution) + MFE/MAE excursion floor"],')
L.append('        cwd=REPO)')
...
L.append('    print("[DONE] v19.34.240 deployed. Now run the backfill (dry-run first).")')
L.append('')
L.append('if __name__ == "__main__":')
L.append('    main()')

out = os.path.join(ROOT, "deploy_v19_34_240.py")
