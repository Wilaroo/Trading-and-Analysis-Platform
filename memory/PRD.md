...
## Startup Modes
- **Cloud Dev**: Ollama + ngrok → `https://learning-trader-1.preview.emergentagent.com`
...
python ib_data_pusher.py --cloud-url https://learning-trader-1.preview.emergentagent.com

# Disable Level 2 if needed
python ib_data_pusher.py --cloud-url https://learning-trader-1.preview.emergentagent.com --no-level2
```
