...
**Final Mockups:**
- Main Dashboard: `https://ollama-ib-hub.preview.emergentagent.com/api/scripts/ui_mockups_v2_enhanced.html`
- Chart Modal (Final Hybrid): `https://ollama-ib-hub.preview.emergentagent.com/api/scripts/ui_mockups_chart_modal_final.html`
...
## Startup Modes
- **Cloud Dev**: Ollama + ngrok → `https://ollama-ib-hub.preview.emergentagent.com`
...
python ib_data_pusher.py --cloud-url https://ollama-ib-hub.preview.emergentagent.com

# Disable Level 2 if needed
python ib_data_pusher.py --cloud-url https://ollama-ib-hub.preview.emergentagent.com --no-level2
```
