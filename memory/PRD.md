...
## Startup Modes
- **Cloud Dev**: Ollama + ngrok → `https://local-ai-trading.preview.emergentagent.com`
...
python ib_data_pusher.py --cloud-url https://local-ai-trading.preview.emergentagent.com

# Disable Level 2 if needed
python ib_data_pusher.py --cloud-url https://local-ai-trading.preview.emergentagent.com --no-level2
```
