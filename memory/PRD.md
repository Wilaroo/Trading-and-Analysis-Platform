...
## Startup Modes
- **Cloud Dev**: Ollama + ngrok → `https://regime-aware-bot.preview.emergentagent.com`
...
python ib_data_pusher.py --cloud-url https://regime-aware-bot.preview.emergentagent.com

# Disable Level 2 if needed
python ib_data_pusher.py --cloud-url https://regime-aware-bot.preview.emergentagent.com --no-level2
```
