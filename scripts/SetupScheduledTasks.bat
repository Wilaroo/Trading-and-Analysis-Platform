...
:: =====================================================
echo [1/4] Removing any existing tasks...
...
:: =====================================================
echo [2/4] Creating Weekend Task...
...
:: =====================================================
echo [3/4] Creating Nightly Task...
...
echo   2. Look for "TradeCommand_Weekend" and "TradeCommand_Nightly"
echo.
