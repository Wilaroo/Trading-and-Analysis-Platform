...
def ssot():
    ...
    return style_of, getattr(TQSEngine, "STYLE_WEIGHTS", {})
...
def main():
    ...
    n = persisted = pattern_ok = weight_ok = weight_checked = stamp_div = 0
    bad_pattern = Counter()
    for d in cur:
        n += 1
    ...
    if bad_pattern:
        ...
        print("\n  \u2705 every persisted alert scored by its pattern-intrinsic style.")
