    ...
    <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-black/40 border border-white/5">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[14px] text-zinc-500 uppercase">Pending</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[14px] text-zinc-500 uppercase">Executing</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[14px] text-zinc-500 uppercase">Filled</p>
        </div>
      </div>
    </div>
  );
