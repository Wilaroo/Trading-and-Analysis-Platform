...
export const CarouselCountdownChip = ({ onManualPick, userHasFocused, currentChartSymbol }) => {
  ...
  if (!userHasFocused) {
    return (
      <div
        ...
        data-mode="auto"
        className="inline-flex items-center gap-1 px-1 py-0.5 rounded-full ring-1 ring-cyan-500/40 bg-cyan-900/15 v5-mono text-[14px] uppercase tracking-wider text-cyan-300"
  ...
  return (
    <div
      data-testid="carousel-countdown-chip"
      data-mode="paused"
      className="inline-flex items-center gap-1 px-1 py-0.5 rounded-full ring-1 ring-zinc-700/60 bg-zinc-900/40 v5-mono text-[14px] uppercase tracking-wider text-zinc-400"
