              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[12px] text-zinc-500">
                    {lastRun
                      ? `Last run ${lastRun.toLocaleTimeString('en-US', { timeZone: 'America/New_York', hour: '2-digit', minute: '2-digit', hour12: false })} ET · ${counts.ok} ok · ${counts.warn} warn · ${counts.fail} fail`
