  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        {loading && (
          <span className="text-[14px] text-zinc-500" data-testid="canonical-universe-loading">
            loading…
          </span>
        )}
      </div>
      ...
      {!error && data && (
        <>
          ...
          <div className="grid grid-cols-3 gap-1.5 mb-2.5">
            ...
            >
              <div className="text-[14px] text-zinc-500 uppercase">Qualified</div>
            ...
            >
              <div className="text-[14px] uppercase opacity-70">
            ...
            <div
              ...
              className="border border-zinc-800 rounded bg-zinc-900/40 px-2 py-1.5"
            >
              <div className="text-[14px] text-zinc-500 uppercase">Unqualifiable</div>
          ...
          <div className="mt-2 text-[14px] text-zinc-500 leading-snug">
