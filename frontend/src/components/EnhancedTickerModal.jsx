...
const BotTakeCard = ({ trade, symbol }) => {
  ...
  const timestamp = trade.entry_time ? new Date(trade.entry_time).toLocaleTimeString('en-US', { timeZone: 'America/New_York', hour: '2-digit', minute: '2-digit' }) + ' ET' : null;
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-3 mt-2 text-[12px] text-zinc-500">
                                  <span className="flex items-center gap-1">
                                    ...
                                    {item.timestamp ? new Date(item.timestamp).toLocaleString('en-US', { timeZone: 'America/New_York' }) + ' ET' : '--'}
                                  </span>
