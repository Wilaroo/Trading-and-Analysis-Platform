    ...
    >
      ...
      {scorecard.validated_at && (
        <div className="mt-2 pt-1 border-t border-zinc-800/40 text-[14px] text-zinc-600 flex justify-between">
          <span>Validated {new Date(scorecard.validated_at).toLocaleString('en-US', { timeZone: 'America/New_York', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' }) + ' ET'}</span>
