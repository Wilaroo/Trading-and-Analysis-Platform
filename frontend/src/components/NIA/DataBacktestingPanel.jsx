              ...
              {tabs.map(tab => (
                ...
                >
                  ...
                  {tab.id === 'validation' && valResults.total > 0 && (
                    <span className="ml-1 px-1.5 py-0.5 rounded-full text-[14px] bg-amber-500/20 text-amber-400">{valResults.total}</span>
                  )}
                  {tab.id === 'backtest' && btResults.length > 0 && (
                    <span className="ml-1 px-1.5 py-0.5 rounded-full text-[14px] bg-violet-500/20 text-violet-400">{btResults.length}</span>
                  )}
                </button>
              ))}
            </div>
