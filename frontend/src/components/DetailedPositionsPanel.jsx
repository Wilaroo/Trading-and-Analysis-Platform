    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          {pos.shares > 0 && (
            <span className="text-[10px] text-zinc-500">{pos.shares.toLocaleString()} sh</span>
          )}
          {/* Portfolio weight */}
          {pos.portfolio_weight > 0 && (
            <span className="text-[9px] px-1.5 py-0.5 rounded bg-white/5 text-zinc-500 border border-white/5">
        ...
        <div className="text-right flex items-center gap-3">
          ...
          <div className="text-right">
            <span className="text-[10px] text-zinc-500 block">{fmt(pos.market_value)}</span>
          </div>
          {/* Total P&L */}
          <div className="text-right">
            ...
            <span className={`text-[10px] ml-1 ${isProfit ? 'text-emerald-400/70' : 'text-rose-400/70'}`}>
      ...
      <div className="grid grid-cols-4 gap-2 mb-2">
        <div>
          ...
          <p className="text-[10px] text-zinc-300 font-mono">${pos.entry_price?.toFixed(2)}</p>
        </div>
        <div>
          <p className="text-[9px] text-zinc-600 uppercase">Current</p>
          <p className="text-[10px] text-white font-mono font-medium">${pos.current_price?.toFixed(2)}</p>
        </div>
        <div>
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        {pos.today_change !== 0 && pos.today_change != null && (
          <span className={`text-[9px] px-1.5 py-0.5 rounded flex items-center gap-0.5 ml-auto ${
      ...
      <div className="px-4 py-3 border-b border-white/10 bg-black/30">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            {positionsAtRisk > 0 && (
              <span className="text-[9px] px-1.5 py-0.5 rounded bg-red-500/20 text-red-400 border border-red-500/30 flex items-center gap-0.5 font-bold">
        ...
        <div className="flex items-center justify-between gap-2">
          {/* Sort buttons */}
          <div className="flex items-center gap-1">
            <span className="text-[9px] text-zinc-600 uppercase mr-1">Sort:</span>
